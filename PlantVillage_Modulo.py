...
# Bloque 3 Capa Extra - Convolucion
# Parte 1 - Convolucion
model.add(Conv2D(input_shape=input_shape ,filters=64, kernel_size=(3, 3), strides=3, activation='relu'))
model.add(MaxPooling2D(pool_size=(2,2)))
model.add(Dropout(0.5))
...
converter = tf.lite.TFLiteConverter.from_saved_model('model.hdf5')
